...
class UkCarouselView extends StatefulWidget {
  const UkCarouselView({super.key});

  Widget build(context, UkCarouselSliderController controller) {
            ...
            children: [
              ...
              Builder(builder: (context) {
                ...
                return CarouselSlider(
                  options: CarouselOptions(
                    scrollDirection:
                        Axis.vertical, // Mengatur orientasi menjadi vertikal
                    height: 160.0,
                    autoPlay: true,
                    enlargeCenterPage: true,
                  ),
                      ...
                      builder: (BuildContext context) {
                        return Container(
                          height: MediaQuery.of(context)
                              .size
                              .height, // Mengubah width menjadi height
                          margin: const EdgeInsets.symmetric(
                              vertical:
                                  5.0), // Mengubah margin horizontal menjadi vertical
                          decoration: BoxDecoration(
                            color: Colors.amber,
                            borderRadius: const BorderRadius.all(
                              Radius.circular(6.0),
  ...
  @override
  State<UkCarouselView> createState() => UkCarouselSliderController();
}

                        ...
                        tabs: <Widget>[
                          Container(
                            child: Row(
                              ...
                              children: <Widget>[
                                Image.network(
                                  'https://res.cloudinary.com/dotz74j1p/raw/upload/v1716045487/h9n0zlh5z3f6zznb71zt.png',
                                  width: 22,
                                ),
                                SizedBox(
                                  width: 6,
                          ...
                          Container(
                            child: Row(
                              ...
                              children: <Widget>[
                                Image.network(
                                  'https://res.cloudinary.com/dotz74j1p/raw/upload/v1716045493/ydgqkjtowbils6hrsskw.png',
                                  width: 22,
                                ),
                                SizedBox(
                                  width: 6,
                          ...
                          Container(
                            child: Row(
                              ...
                              children: <Widget>[
                                Image.network(
                                  "https://res.cloudinary.com/dotz74j1p/raw/upload/v1716045497/n2r8uxq2ewtgs4kjufxu.png",
                                  width: 22,
                                ),
                                SizedBox(
                                  width: 6,
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            child: Align(
                              child: Image.network(
                                'https://res.cloudinary.com/dotz74j1p/raw/upload/v1716045505/mjkpc6zotlrpw3wbvban.png',
                                width: 28,
                                height: 28,
                              ),
                            ),
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          child: Align(
                            child: Image.network(
                              'https://res.cloudinary.com/dotz74j1p/raw/upload/v1716045510/lweoxbvizsglrqwxcdod.png',
                              width: 30,
                              height: 30,
                            ),
                          ),
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          child: Align(
                            child: Image.network(
                              'https://res.cloudinary.com/dotz74j1p/raw/upload/v1716045513/yp9liiin2vdstf9shqit.png',
                              width: 28,
                              height: 28,
                            ),
                          ),
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          child: Align(
                            child: Image.network(
                              'https://res.cloudinary.com/dotz74j1p/raw/upload/v1716045516/p8u1zp0j0ee2qmtnhxsh.png',
                              width: 28,
                              height: 28,
                            ),
                          ),
...
class HomeContent extends StatelessWidget {
  ...
  Widget profileButton() {
    return Container(
      ...
      child: Align(
        child: Image.network(
          'https://res.cloudinary.com/dotz74j1p/raw/upload/v1716045533/xcmrwvyngqeu09ng2kld.png',
          width: 24,
        ),
      ),
    );
      ...
      child: Column(
        ...
        children: <Widget>[
          Row(
            children: <Widget>[
              Image.network(
                "https://res.cloudinary.com/dotz74j1p/raw/upload/v1716045542/j4p0eoilhaqcqfupngff.png",
                width: 12,
                color: Colors.blue,
              ),
              SizedBox(

...
class TemplateChatDetailView extends StatelessWidget {
  const TemplateChatDetailView({super.key});
    ...
    List messageList = [
      {
        ...
        "sender": {
          "name": "Keanue Reeve",
          "avatar_url":
              "https://res.cloudinary.com/dotz74j1p/raw/upload/v1716045217/cpchq4frehn4ydctacat.png",
        }
      },
      {
        "message": "",
      ...
      },
      {
        ...
        "sender": {
          "name": "Keanue Reeve",
          "avatar_url":
              "https://res.cloudinary.com/dotz74j1p/raw/upload/v1716045223/qitwmahvzoiej5v5oeck.png",
        }
      },
      {
        "message": "Haha, Cool!",

...
class TemplateProfileELearningView extends StatelessWidget {
  const TemplateProfileELearningView({super.key});

  @override
  Widget build(BuildContext context) {
    //#GROUP_TEMPLATE view
    //#TEMPLATE ui_profile_elearning
    /*
    ------------------------
                ...
                child: const Padding(
                  ...
                  child: CircleAvatar(
                    ...
                    backgroundImage: NetworkImage(
                      "https://res.cloudinary.com/dotz74j1p/raw/upload/v1716045556/vgjiy9kqyrnnnhoia4kv.png",
                    ),
                  ),
                ),
              ),
